...
The controller works to delegate the input to the model, and displays message to the user through
view. The controller also takes in the output from the model and displays it as required using the
view methods.

The Alpha Vantage API is used to fetch the data for stock which the user wants to get 
total value of. 
